              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                    name="title" value="{{ old('title', $schedule->title) }}" required autocomplete="off">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="start_date" type="date" class="form-control @error('start_date') is-invalid @enderror"
                    name="start_date" value="{{ old('start_date', $schedule->start_date) }}" required autocomplete="off">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror"
                    name="end_date" value="{{ old('end_date', $schedule->end_date) }}" required autocomplete="off">
